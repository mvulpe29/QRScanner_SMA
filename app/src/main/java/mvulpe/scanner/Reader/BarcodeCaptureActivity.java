...
import mvulpe.scanner.R;
import mvulpe.scanner.Reader.ui.CameraSource;
import mvulpe.scanner.Reader.ui.CameraSourcePreview;
...
//        if(!hasFlash) l.setVisibility(View.GONE);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        BarcodeTrackerFactory barcodeFactory = new BarcodeTrackerFactory(mGraphicOverlay, new BarcodeGraphicTracker.BarcodeAutoDetectionListener() {
            @Override
